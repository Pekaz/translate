...
2019년에는 트위터의 주가를 제외한 대부분의 지표가 정체되어 있습니다. 팔로어 수가 꼭 포스트에 관연관된
사람을 표현하는 것은 아니다. 예를 들어, 수많은 팔로워가 있는 브랜드가 사실상 아무 인터렉션이 없는 포스트를
올리는 것은 드문 일이 아니다. (이 회사는 최근 다른 지표도 없앴는데, 더이상 "월별 활성 사용자"를 투자자에게
보고하지 않고, 대신에 좀 더 유리한 내용인 "일별 활성 사용자"를 강조할 것이다.)

본인들이 말하길 인스타그램은 여전히 활발하게 성장하고 있고 그러므로 페이스북의 자랑거리 일수도 있다.
한가지 문제는, 좋아요를 숨김으로써 사람들이 그들의 피드에 더이상 예전처럼 포스팅을 많이 하지 않는 다는
것이다. 대신에 스토리를 올리고 있는데 그건 스냅쳇을 따라한 과도기적인 형식이다. 보통의 인스타그램 포스팅에서
지표들을 제거하는건 유저들에게 스트레스를 약간 덜어줄 수 있을 것이다. 또한 처음에 인스타그램을 인기 있게
만들어 주었던 것이 점차 감소하고 있다는 느낌을 줄이는데 도움을 줄 것이다.
```
